		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#fioridemoui5invoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioridemoui5invoices-display": {
								"semanticObject": "fioridemoui5invoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioridemo.ui5.invoices",
									"url": sap.ui.require.toUrl("fioridemo/ui5/invoices")
								}
							}
						}
					}
